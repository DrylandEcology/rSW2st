test_that("as_points", {
  ...
  expect_equal(sf::st_coordinates(pts_sf), locations, ignore_attr = TRUE)

  pts_sfc <- as_points(locations, crs = 4326, to_class = "sfc")
  expect_s3_class(pts_sfc, "sfc")
  expect_equal(sf::st_coordinates(pts_sfc), locations, ignore_attr = TRUE)

  pts_sp <- as_points(locations, crs = 4326, to_class = "sp")
  expect_s4_class(pts_sp, "SpatialPoints")
  expect_equal(sp::coordinates(pts_sp), locations, ignore_attr = TRUE)
  ...
  expect_equal(sf::st_coordinates(pts_df_sf), locations, ignore_attr = TRUE)
  ...
  expect_equal(sf::st_coordinates(pts_df_sfc), locations, ignore_attr = TRUE)
  ...
  expect_equal(sp::coordinates(pts_df_sp), locations, ignore_attr = TRUE)
  ...
  expect_equal(sf::st_coordinates(pts_sp_sf), locations, ignore_attr = TRUE)
  ...
  expect_equal(sf::st_coordinates(pts_sp_sfc), locations, ignore_attr = TRUE)
  ...
  expect_equal(sp::coordinates(pts_sfc_sp), locations, ignore_attr = TRUE)
  ...
  expect_equal(sf::st_coordinates(pts_sfc_sf), locations, ignore_attr = TRUE)
  ...
  expect_equal(sp::coordinates(pts_sf_sp), locations, ignore_attr = TRUE)
  ...
  expect_equal(sf::st_coordinates(pts_sf_sfc), locations, ignore_attr = TRUE)
  ...
  expect_equal(sf::st_coordinates(pts_sf1), locations[1, ], ignore_attr = TRUE)
